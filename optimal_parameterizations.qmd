...
The player-level estimates are ordered by the number of at-bats in the full season.
As in the preceding plots, the thin interval represents average within-run posterior uncertainty,
the thick interval represents variation in the posterior median across repeated fits,
and opacity represents the proportion of runs passing the R-hat criteria.
